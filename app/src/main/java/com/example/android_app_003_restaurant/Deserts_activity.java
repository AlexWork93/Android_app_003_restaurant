...
public class Deserts_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView deserts_list = findViewById(R.id.list_view_deserts);
        ...
        deserts_list.setAdapter(desertsAdapter);
